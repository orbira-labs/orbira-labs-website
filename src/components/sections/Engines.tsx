...
const ENGINES = [
  {
    ...
    shortName: "HAE",
    description: "3.000+ parametre. Çok katmanlı hibrit analiz. AI-validated profil sentezi.",
    status: "active",
    version: "2.0",
    ...
    specs: [
      { label: "Doğruluk", value: "~%96" },
      { label: "Boyut", value: "100+" },
    ],
    useAtom: true,
    icon: null,
  },
  {
    ...
    shortName: "AQE",
    description: "3.500+ soru kütüphanesi. 1 milyar+ benzersiz test yolu. Aynı test yok.",
    status: "active",
    version: "1.0",
