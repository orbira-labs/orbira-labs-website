...
const ENGINES = [
  {
    ...
    shortName: "HAE",
    description: "183 trait. 35 pattern. 11 katman. Her bireye benzersiz profil.",
    status: "active",
    version: "2.0",
  ...
  },
  {
    ...
    shortName: "AQE",
    description: "350+ soru. 25 havuz. 1M+ benzersiz test yolu.",
    status: "active",
    version: "1.0",
    ...
    iconBg: "bg-transparent",
    specs: [
      { label: "Soru", value: "350+" },
      { label: "Havuz", value: "25" },
    ],
    useLabyrinth: true,
    icon: null,
  },
