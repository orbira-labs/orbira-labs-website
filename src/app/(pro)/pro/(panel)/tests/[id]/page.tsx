...
import { WellnessGauge } from "@/components/pro/results/WellnessGauge";
import { DimensionRadar } from "@/components/pro/results/DimensionRadar";
import { StrengthWeaknessGrid } from "@/components/pro/results/StrengthWeaknessGrid";
import { CharacterAnalysis } from "@/components/pro/results/CharacterAnalysis";
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4 mt-1 text-sm text-pro-text-secondary">
                  ...
                  {test.client && (
                    <Link
                      href={`/pro/clients/${test.client_id}`}
