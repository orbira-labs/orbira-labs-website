          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
            <Card padding="lg">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/pro/appointments" className="text-sm text-pro-primary hover:underline">
                  Tümü
                </Link>
              </div>
              {upcomingAppointments.length === 0 ? (
                <EmptyState
                  ...
                  description="Danışanlarınızla randevu oluşturarak takibinizi kolaylaştırın"
                />
              ) : (
            ...
            <Card padding="lg">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/pro/tests" className="text-sm text-pro-primary hover:underline">
                  Tümü
                </Link>
              </div>
              {recentTests.length === 0 ? (
                <EmptyState
                  ...
                  description="İlk karakter analizinizi bir danışanınıza gönderin"
