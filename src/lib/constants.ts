...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    id: "orbiramind",
    name: "Orbira Mind",
    description: "Danışan yönetiminde profesyonel asistanınız. Randevu takibi, seans notları ve AI destekli derinlemesine karakter analizleri — hepsi tek platformda.",
    status: "testing",
    category: "business",
    icon: "🧠",
    gradient: "from-[#5B7B6A] to-[#3D5A4C]",
    features: ["Danışan Yönetimi", "Randevu Takvimi", "MindTest Analiz", "AQE & HAE Entegrasyonu"],
    href: "/products/orbiramind",
    logo: "/images/orbiramind-icon.svg",
    screenshots: [
      "/images/orbiramind-dashboard.png",
      "/images/orbiramind-calendar.png",
      "/images/orbiramind-engines.png",
    ],
  },
  {
    id: "orbiweb",
    name: "OrbiWeb",
    description: "İşletmenize özel web sitesi ve mobil uygulama. Otel, restoran, cafe, beach club, spa ve daha fazlası için sıfırdan, markanıza özel tasarımlar.",
    status: "live",
    category: "business",
    icon: "🌐",
    gradient: "from-[#7C3AED] to-[#4F46E5]",
    features: ["Özel Tasarım", "Mobil Uygulama", "Domain & Hosting", "Anahtar Teslim"],
    href: "/products/orbiweb",
    logo: "/images/orbiweb-icon.svg",
    screenshots: [
      "/images/orbiweb-hero.png",
      "/images/orbiweb-templates-1.png",
      "/images/orbiweb-process.png",
    ],
  },
  {
    id: "cep-hocam",
